...
SELECT geom.Reduce(0.05) AS Simplified --насколько сильно должен быть упрощен геометрический объект
FROM myPackage
WHERE qgs_fid = 6
...
SET @polygonGeometry = GEOMETRY::STGeomFromText('POLYGON((15 10, 25 25, 5 4, 12 2, 15 10))', 0);
